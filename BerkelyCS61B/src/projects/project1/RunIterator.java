...
private run iteratorPointer;
 ...
 // Your solution here.  You may add parameters to the method signature.
   ...
   */
  public int[] next() {
	 //run thisrun=this.iteratorPointer;
	  int[] ints=new int[4];
	  ints[0]=iteratorPointer.runlength;
	  ints[1]=iteratorPointer.red;
	  ints[2]=iteratorPointer.green;
	  ints[3]=iteratorPointer.blue;
	  this.iteratorPointer=iteratorPointer.next;
