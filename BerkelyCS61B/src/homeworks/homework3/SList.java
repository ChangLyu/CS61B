...
public class SList {
  ...
  public void squish() {
	  if(!(this.head==null)){
	  SListNode currentNode1=this.head;
	  SListNode currentNode2=this.head.next;
	  while(!(currentNode2==null)){
	  if(currentNode1.item.equals(currentNode2.item)){
		  currentNode2=currentNode1.next=currentNode2.next;
		  this.size--;
		  	  }else{
  ...
  public void twin() {
		  ...
		  while(!(pointer==null)){
		  pointer.next=new SListNode(pointer.item,pointer.next) ;
