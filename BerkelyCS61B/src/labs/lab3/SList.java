...
public class SList {
	  ...
	  private int size;
	  private SListNode tail;// i create a tail always pointing to the last object in the list
      ...
      private static void part1(){
    	  SList lst10= new SList();
    	  lst10.insertEnd(new Integer(6));
    	  lst10.insertEnd(new Integer(9));
    	  lst10.insertEnd(new Integer(12));
    	  System.out.println(lst10);
    	  lst10.insertFront(new Integer(3));
    	  lst10.insertEnd(new Integer(15));
    	  System.out.println(lst10);
